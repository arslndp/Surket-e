...
<style type="text/css">
  .right{margin-left: 200px; }
                                ...
                                <h2 class="card-inside-title">Nama Lengkap  : {{$non_ktp->Nama}}</h2>
                                
                                <h2 class="card-inside-title">Jenis Kelamin  : {{$non_ktp->jenis_kelamin}}</h2>
                                    
                                <h2 class="card-inside-title">Tempat Tgl.Lahir/Umur : {{$non_ktp->Tempat_ttl}}</h2>
                                      
                                <h2 class="card-inside-title">Pekerjaan : {{$non_ktp->pekerjaan}}</h2>
                                   

                                <h2 class="card-inside-title">Alamat  : {{$non_ktp->alamat}}</h2>
...
<br>
    ...
    <br>                                  
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                <h class="card-inside-title">Bekasi,{{date('d-m-Y')}}<br>
                                <h>Ketua RT.007</h>
                                <br>
<br>
 <br>
