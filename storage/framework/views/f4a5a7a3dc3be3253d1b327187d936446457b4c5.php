...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="<?php echo e($basedir); ?>/images/favicon/favicon-32x32.png" sizes="32x32">
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="<?php echo e($basedir); ?>/images/favicon/apple-touch-icon-152x152.png">
  <!-- For iPhone -->
  <meta name="msapplication-TileColor" content="#00bcd4">
  <meta name="msapplication-TileImage" content="<?php echo e($basedir); ?>/images/favicon/mstile-144x144.png">
  <!-- For Windows Phone -->


     <link href="<?php echo e($basedir); ?>/style.css" rel="stylesheet">
    <link href="<?php echo e($basedir); ?>/js/plugins/bootstrap-select/css/bootstrap-select.css" rel="stylesheet" />
      <link href="<?php echo e($basedir); ?>/css/bootstrap.css" rel="stylesheet">
  <link href="<?php echo e($basedir); ?>/css/materialize.css" type="text/css" rel="stylesheet" media="screen,projection">
  <link href="<?php echo e($basedir); ?>/css/style.css" type="text/css" rel="stylesheet" media="screen,projection">


  <!-- INCLUDED PLUGIN CSS ON THIS PAGE -->
  <link href="<?php echo e($basedir); ?>/css/prism.css" type="text/css" rel="stylesheet" media="screen,projection">
  <link href="<?php echo e($basedir); ?>/js/plugins/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet" media="screen,projection">
  <link href="<?php echo e($basedir); ?>/js/plugins/chartist-js/chartist.min.css" type="text/css" rel="stylesheet" media="screen,projection">
<style>
.white{
    background: white;
    color:black;
...
<body>
              ...
              <li class="user-details cyan darken-2">
                  <div class="row">
                      ...
                      <div class="col col s8 m8 l8">
                          ...
                          <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown"><?php echo e(Auth::user()->name); ?><i class="mdi-navigation-arrow-drop-down right"></i></a>
  ...
  <?php endif; ?>
    ...
    <!-- jQuery Library -->
    <script type="text/javascript" src="<?php echo e($basedir); ?>/js/jquery-1.11.2.min.js"></script>    
    <!--materialize js-->
    <script type="text/javascript" src="<?php echo e($basedir); ?>/js/materialize.js"></script>
    <!--prism-->
    <script type="text/javascript" src="<?php echo e($basedir); ?>/js/prism.js"></script>
    <!--scrollbar-->
    <script type="text/javascript" src="<?php echo e($basedir); ?>/js/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <!-- chartist -->
    <script type="text/javascript" src="<?php echo e($basedir); ?>/js/plugins/chartist-js/chartist.min.js"></script>   
    <script src="<?php echo e($basedir); ?>/js/pages/forms/basic-form-elements.js"></script>
    
    <!--plugins.js - Some Specific JS codes for Plugin Settings-->
    <script type="text/javascript" src="<?php echo e($basedir); ?>/js/plugins.js"></script>
